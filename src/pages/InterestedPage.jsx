      ...
      <div className="min-h-screen bg-[#0f1117] text-gray-100">
       <Header />
        ...
        <section className="max-w-2xl mx-auto px-6 py-20 text-center">
          <div className="bg-[#1a1c23] border border-emerald-500/30 rounded-xl p-8">
     ...
     <Header/>
      ...
      <section className="text-center py-16 px-4 sm:px-6 max-w-3xl mx-auto">
        ...
        <p className="text-gray-400 mb-8 text-sm sm:text-base leading-relaxed">
          ...
          <br />You'll get a custom-built space with tailored design, secure backend,
      ...
      {/* How It Works */}
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-16 border-y border-gray-800 bg-[#14161d]">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-800 text-white font-medium px-6 py-3 rounded-lg shadow transition-colors"
            >
