...
export default function SignIn() {
  ...
  const handleSocialSignIn = (provider: string) => signIn(provider, { callbackUrl });
      ...
      <div className="relative sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-zinc-900/60 border border-zinc-800 backdrop-blur-sm py-8 px-6 rounded-xl sm:px-8">
          ...
          <div className="text-center mb-6">
            <h1 className="text-2xl sm:text-3xl font-semibold text-white">Sign in to your account</h1>
          ...
          <form className="space-y-5" onSubmit={handleSubmit} noValidate>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 text-sm text-zinc-300">
                <input id="remember-me" type="checkbox" className="h-4 w-4 rounded border-zinc-700 bg-zinc-900 text-emerald-600 focus:ring-emerald-500" />
                Remember me
              </label>
